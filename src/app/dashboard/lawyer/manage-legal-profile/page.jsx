...
const statusStyles = {
  ...
  busy: {
    badge: "text-orange-700 border-orange-500/40 bg-orange-50",
    dot: "bg-orange-500",
  },
};

const LawyerProfile = async () => {
              ...
              <Table.Content aria-label="Services List Container">
                ...
                <Table.Body>
                  {services && services.length > 0 ? (
                    ...
                    <Table.Row>
                      <Table.Cell className="p-4 text-center text-black/50 font-medium">
