 ...
 const handleGoogleSignIn = async () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0e345c] px-4">
      ...
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-[#814f30]/10 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-[#1A2E44]/50 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="relative w-full max-w-md rounded-3xl border border-[#2A486A]/50 bg-[#1F3752]/60 backdrop-blur-xl p-8 shadow-2xl">
        ...
        <div className="mb-8 text-center">
          <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl border border-[#814f30]/30 bg-[#814f30]/10">
            <FaLock className="text-xl text-[#814f30]" />
          </div>
        ...
        <button
          ...
          className="flex h-11 w-full items-center justify-center mb-2 gap-3 rounded-xl border border-[#2A486A] bg-[#1A2E44]/80 text-sm font-medium text-white transition-all hover:border-[#814f30]/60 hover:bg-[#1A2E44] active:scale-[0.98]"
        >
