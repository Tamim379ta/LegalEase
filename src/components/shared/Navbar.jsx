  ...
  return (
    <nav className="bg-white border-b border-[#e8e2d9] sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-[68px] flex items-center justify-between gap-6">
        ...
        {/* Desktop Search */}
        <div className="hidden md:flex items-center gap-2 flex-1 max-w-xs bg-[#f8f7f4] border border-[#e8e2d9] rounded-xl px-3.5 py-2 focus-within:border-[#814f30] transition-all">
        ...
        {/* Hamburger */}
        <button
          className="md:hidden text-[#814f30] text-2xl"
